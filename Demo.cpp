...
int main() {
	// family::Tree T ("Dvir"); // Yosef is the "root" of the tree (the youngest person).

	//  T.addFather("Dvir", "David")   // Tells the tree that the father of Yosef is Yaakov.
	//  .addMother("Dvir", "Sofia")   // Tells the tree that the mother of Yosef is Rachel.
	//  .addFather("David", "Aramand")
	//  .addMother("David", "Gracia")
	//  .addFather("Sofia", "Gershon")
	//  .addMother("Sofia", "Haya")
	//  .addFather("Gershon","Avraham")
	//  .addMother("Gershon","Elizabeth");
	...
	cout << T.relation("Terah") << endl;  // prints "father"
